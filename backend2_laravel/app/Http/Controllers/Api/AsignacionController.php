...
class AsignacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_asignacion=Asignacion::create($asignacion);
    ...
    {
        $asignacion=Asignacion::with(['fk_usuario','fk_rol','fk_sedereg','fk_sedejuris'])->findOrFail($id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validate=$request->validate([
            'id_usuario'=>'required|unique:usuario,id_usuario|integer',
            'id_rol'=>'nullable|integer',
            'id_sedereg'=>'nullable|integer',
            'id_sedejuris'=>'nullable|integer'
        ]);
